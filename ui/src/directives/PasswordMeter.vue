<template>
  <div>
    <input tabindex="0" id="pass-meter-input" :disabled="!canChangePassword" v-model="confirmPassword" @input="updateMeter()" :type="$parent.newUser.togglePass ? 'text' : 'password'" class="form-control" />
